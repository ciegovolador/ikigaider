...
export default {
  ...
  'config.engine.note': 'Runs a model on your device with WebGPU. One-time download; nothing leaves your machine.',
  'config.webgpu.ok': 'WebGPU detected ✓',
  'config.webgpu.no': 'No WebGPU in this browser — use desktop Chrome/Edge, or your own endpoint.',
